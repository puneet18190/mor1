...
function dTree(objName) {
    ...
    this.icon = {
        ...
        root:mor_web_dir + '/images/dtree/base.gif',

        folder:mor_web_dir + '/images/dtree/folder.gif',

        folderOpen:mor_web_dir + '/images/dtree/folderopen.gif',

        node:mor_web_dir + '/images/dtree/page.gif',
