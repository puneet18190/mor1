...
INSERT INTO `conflines` (`id`, `name`, `value`, `owner_id`, `value2`) VALUES
(501, 'Invoice_To_Pay_Line', '', 0, NULL),
(502, 'Invoice_Add_Average_rate', '0', 0, NULL),
(503, 'Invoice_Show_Time_in_Minutes', '0', 0, NULL),
(504, 'Show_recordings_with_zero_billsec', '0', 0, NULL),
(505, 'Invoice_Short_File_Name', '0', 0, NULL),
(506, 'Invoice_user_billsec_show', '0', 0, NULL),
(507, 'Invoice_show_additional_details_on_separate_page', '0', 0, ''),
(508, 'Prepaid_Invoice_To_Pay_Line', '', 0, NULL),
(509, 'Prepaid_Invoice_Add_Average_rate', '0', 0, NULL),
(510, 'Prepaid_Invoice_Show_Time_in_Minutes', '0', 0, NULL);
INSERT INTO `conflines` (`id`, `name`, `value`, `owner_id`, `value2`) VALUES
(475, 'Tax_compound', '1', 0, NULL),
