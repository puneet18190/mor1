...
INSERT INTO `destinations` (`id`,`prefix`,`direction_code`,`name`     ,`destinationgroup_id`)
VALUES                    (200431, 555333 ,''             ,'testini_s' ,                   0);

UPDATE destinations SET direction_code = 'LTU' WHERE prefix = '555333';