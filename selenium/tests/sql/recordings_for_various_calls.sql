...
#tik admino
INSERT INTO `recordings` (`id`, `datetime`         , `src`        , `dst`        , `src_device_id`, `dst_device_id`, `call_id`, `user_id`, `path`, `deleted`, `send_time`, `comment`, `size`, `uniqueid`    , `visible_to_user`, `dst_user_id`, `local`, `visible_to_dst_user`) VALUES
                         (21, '2014-11-01 12:09:17', '37060011221', '37060011224', 4              , 17              , 211      , 0        , ''    , 0        , NULL       , ''       , 1024  , '1232113373.3', 1                , 2            , 1      , 1),
                         (22, '2014-11-02 12:38:17', '37060011221', '37060011224', 17              , 2              , 211      , 0        , ''    , 0        , NULL       , ''       , 1024  , '1232113373.3', 1                , 2            , 1      , 1);
#tik reselerio
INSERT INTO `recordings` (`id`, `datetime`         , `src`        , `dst`        , `src_device_id`, `dst_device_id`, `call_id`, `user_id`, `path`, `deleted`, `send_time`, `comment`, `size`, `uniqueid`    , `visible_to_user`, `dst_user_id`, `local`, `visible_to_dst_user`) VALUES
                         (23, '2014-11-01 13:45:13', '37060011221', '37060011224', 7              , 21              , 211      , 0        , ''    , 0        , NULL       , ''       , 1024  , '1232113373.3', 1                , 2            , 1      , 1),
                         (24, '2014-11-02 13:55:13', '37060011221', '37060011224', 21              , 7              , 211      , 0        , ''    , 0        , NULL       , ''       , 1024  , '1232113373.3', 1                , 2            , 1      , 1);
